                ...
                <div class="row justify-content-center"> <!-- Centrar contenido -->
                    <div class="col-lg-6"> <!-- Tamaño del contenedor del formulario -->
                        ...
                        <div class="card mb-4 mt-5 bg-dark text-white">
                            ...
                            <div class="card mb-4 mt-5 bg-dark text-white">
                                <div class="card-body">
                                    <form action="{{ route('DashboardAlbum.update', $album->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row mb-3 align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control" id="release_year"
                                                    name="release_year" value="{{ $album->release_year }}" required>
                                            </div>
                                        </div>
                                        <div class="row mb-3 align-items-center">
                                            <label for="cover_image_url" class="fw-bold col-sm-3 col-form-label text-end">Imagen : </label>
                                            <div class="col-sm-9 text-center">
                                                <img src="{{ asset('storage/' . $album->cover_image_url) }}" alt="Album Cover" class="img-fluid" style="max-width: 30%;">
                                                <input type="file" class="form-control mt-2" id="cover_image_url" name="cover_image_url" accept="image/*">
                                            </div>
                                        </div>
