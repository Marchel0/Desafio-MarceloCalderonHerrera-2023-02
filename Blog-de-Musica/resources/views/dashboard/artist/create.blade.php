                ...
                <div class="row justify-content-center"> <!-- Centrar contenido -->
                    <div class="col-lg-6"> <!-- Tamaño del contenedor del formulario -->
                        ...
                        <div class="card mb-4 mt-5 bg-dark text-white">
                            <h2 class="text-center">CREAR REGISTRO ARTISTA</h2>
                            <div class="card mb-4 mt-5 bg-dark text-white">
                                <div class="card-body">
                                    <form action="{{ route('DashboardArtist.store') }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="row mb-3 align-items-center">
                                            <label for="group_type" class="fw-bold col-sm-3 col-form-label text-end">Tipo de
                                                artista : </label>
                                            <div class="col-sm-9">
                                                <select class="js-example-basic-single form-control js-states" name="group_type" id="group_type">
